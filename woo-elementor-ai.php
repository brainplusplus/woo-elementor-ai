...
function woo_elementor_ai_missing_elementor_notice(): void {
    ...
    <div class="notice notice-error">
        <p>
            <strong><?php esc_html_e( 'Woo Elementor AI', 'woo-elementor-ai' ); ?></strong>
            <?php esc_html_e( 'requires Elementor to be installed and active.', 'woo-elementor-ai' ); ?>
        </p>
    </div>
    <?php
}
...
function woo_elementor_ai_init(): void {
    if ( ! woo_elementor_ai_is_elementor_active() ) {
        add_action( 'admin_notices', 'woo_elementor_ai_missing_elementor_notice' );
        return;
    }
